...
function onInputChange(e) {
  ...
  console.log("FileUploadResource: ", resource)
  console.log("FileUploadFolder: ", folder)
	e.target.value = null // reset so that selecting the same file again will still cause it to fire this change
}

//TODO: Pass resource and folder to createUploader
// Uploader
import createUploader from './file-uploader'
const { uploadFiles } = createUploader('files')
</script>
